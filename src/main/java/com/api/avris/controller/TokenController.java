...
public class TokenController {
    ...
    @PostMapping("/signin")
    public ApiResponse<Users> getToken(@RequestParam("handphone") final String handphone){
        return new ApiResponse<>(HttpStatus.OK.value(), "success", usersService.login(handphone));
    }
